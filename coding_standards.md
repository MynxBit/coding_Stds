 ...
 *   - [Only if unavoidable, list additional responsibilities]
 * 
 * NON-RESPONSIBILITIES (What this file must NEVER do):
 *   - [Explicit list of what this file must not handle]
 * 
 * ───────────────────────────────────────────────────────────────────────────
 * DEPENDENCIES (imports):
 *   - [file1.ext] → [reason for dependency]
 *   - [file2.ext] → [reason for dependency]
 * 
 ...
 * ───────────────────────────────────────────────────────────────────────────
 * CHANGE LOG:
 *   [YYYY-MM-DD] - [Author/AI] - [Brief description of change]
 * ═══════════════════════════════════════════════════════════════════════════
 */
```
